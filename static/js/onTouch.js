...
l.push(name);
document.getElementById(l[1]).style.fill="#FC100D";
document.getElementById("setCurrent").innerHTML=l[1];
console.log(l);
if(l.length==3){
  showPath();
}
...
function showPath(){ 
 current = l[1];
 destination = l[2];
document.getElementById(l[2]).style.fill="#4BB543";
document.getElementById("setDestination").innerHTML=l[2];
shortestPath();
}
...
//First Floor Graph
  ...
  "Room G19p":{"Room G18p"  : 1 , "Room G20p"  : 1 , "HOD MEp" : 1,"Boys WashRoom2p":1},
  ...
  "Room G36p":{"Room G37p"  : 1 , "Boys Washroom1p"  : 1 },
  ...
  "Boys WashRoom2p":{"Room G18p":1},
};
//if(current=="Boys WashRoom1")
...
//for side bar
/*function openNavforGFM() {
  document.getElementById("gFM").innerHTML='<object type="text/html" data="groundFloorTouchMap.html" ></object>';
}*/
// Check if file is completely ready
function openNavforFFM() {
  document.getElementById("fFM").style.width = "100%";
}

function closeNav() {
  document.getElementById("gFM").style.width = "0";
  document.getElementById("fFM").style.width = "0";
}